...
/**
 * Adds a measure to another, mutating it.
 * 
 * @param addend The measure to add
 * 
 * @since 2024-08-02
 */
operator fun <U : Unit<U>> MutableMeasure<U>.plusAssign(addend: Measure<U>) {
    this.mut_plus(addend)
}

/**
 * Adds a double to this measure, assuming it was the same unit.
 * 
 * @param addend The amount to add
 * 
 * @since 2024-08-02
 */
operator fun <U : Unit<U>> MutableMeasure<U>.plusAssign(addend: Double) {
    this.mut_plus(addend, this.unit())
}

/**
 * Subtracts a measure from another, mutating it.
 * 
 * @param subtrahend The measure to subtract
 * 
 * @since 2024-08-02
 */
operator fun <U : Unit<U>> MutableMeasure<U>.minusAssign(subtrahend: Measure<U>) {
    this.mut_minus(subtrahend)
}

/**
 * Subtracts a double rom this measure, assuming it was the same unit.
 * 
 * @param subtrahend The amount to subtract
 * 
 * @since 2024-08-02
 */
operator fun <U : Unit<U>> MutableMeasure<U>.minusAssign(subtrahend: Double) {
    this.mut_minus(subtrahend, this.unit())
}

/**
 * Multiplies a measure with a dimensionless measure, mutating it.
 * 
 * @param multiplicand The measure to multiply
 * 
 * @since 2024-08-02
 */
operator fun <U : Unit<U>> MutableMeasure<U>.timesAssign(multiplicand: Measure<out Dimensionless>) {
    this.mut_times(multiplicand)
}

/**
 * Multiplies a double to this measure.
 * 
 * @param multiplicand The amount to multiply
 * 
 * @since 2024-08-02
 */
operator fun <U : Unit<U>> MutableMeasure<U>.timesAssign(multiplicand: Double) {
    this.mut_times(multiplicand)
}

/**
 * Divides this measure by dimensionless measure, mutating it.
 * 
 * @param divisor The measure to divide
 * 
 * @since 2024-08-02
 */
operator fun <U : Unit<U>> MutableMeasure<U>.divAssign(divisor: Measure<out Dimensionless>) {
    this.mut_times(divisor)
}

/**
 * Divides this measure by a double.
 * 
 * @param divisor The amount to divide
 * 
 * @since 2024-08-02
 */
operator fun <U : Unit<U>> MutableMeasure<U>.divAssign(divisor: Double) {
    this.mut_times(divisor)
}
